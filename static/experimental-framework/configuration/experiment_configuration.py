...
class ExperimentConfiguration:
    ...
    def __init__(self, network_configuration, topology_configuration, firedex_configuration):
        ...
        broker_host = topology_configuration.broker()["broker_host"]
        gateway_host = topology_configuration.broker()["gateway_host"]
        ...
        for subscriber_group in subscriber_scenario:
            ...
            for i in range(subscriber_count):
                ...
                running_time = firedex_configuration.experiment_duration() + 130
                subscriptions = []
                ...
                subscriber = {
                    ...
                    "output": {
                        "logFile": ("/var/log/subscriber/log/%s_log.log" % identifier),
                        "outputFile": ("/var/log/subscriber/output/%s_output.json" % identifier)
                    }
                }
        ...
        for publisher_group in publisher_scenario:
            ...
            for i in range(publisher_count):
                ...
                publisher = {
                    ...
                    "output": {
                        "logFile": ("/var/log/publisher/log/%s_log.log" % identifier),
                        "outputFile": ("/var/log/publisher/output/%s_output.json" % identifier)
                    }
                }
